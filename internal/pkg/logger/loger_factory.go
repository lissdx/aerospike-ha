...
// LoggerFactory constructs the concrete
// ILogger interface implementor
// currently supports Zap logger implementor
// and noop logger implementor
// noop logger implementor is ignoring all
// logging calls
func LoggerFactory(option ...Option) ILogger {
	...
	case bufferedLogImplementor:
		return NewBufferLogger(lcgf.printToIO)
